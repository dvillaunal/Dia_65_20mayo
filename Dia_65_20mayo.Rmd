...
Vamos a Jugar una especie de baloto, es decir, tendremos una columna con el nombre del jugador, una con el Panel (del A al E) otra con la que convertiremos en matriz, otra con los tres numeros que escogio para jugar:
...
Vamos a calcular las ganancias de los chances directos (sin combinatoria), si son ganadores
